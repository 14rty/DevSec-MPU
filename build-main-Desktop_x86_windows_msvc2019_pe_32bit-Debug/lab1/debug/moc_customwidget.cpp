...
#include "../../../labba1/lab1/customwidget.h"
...
static constexpr auto qt_meta_stringdata_CustomWidget = QtMocHelpers::stringData(
    "CustomWidget",
    "sendRemoveItem",
    "",
    "url",
...
Q_CONSTINIT static const qt_meta_stringdata_CustomWidget_t qt_meta_stringdata_CustomWidget = {
    {
        ...
        QT_MOC_LITERAL(13, 14),  // "sendRemoveItem"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 3),  // "url"
        QT_MOC_LITERAL(33, 5),  // "login"
        QT_MOC_LITERAL(39, 21),  // "on_toolButton_clicked"
        QT_MOC_LITERAL(61, 23)   // "on_deleteButton_clicked"
    },
    "CustomWidget",
    "sendRemoveItem",
    "",
...
void CustomWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendRemoveItem((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        ...
        {
            using _t = void (CustomWidget::*)(const QString , const QString );
            if (_t _q_method = &CustomWidget::sendRemoveItem; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomWidget::sendRemoveItem(const QString _t1, const QString _t2)
{
